...
export default function CategoryFilter({ active, onChange, resultCount }) {
  return (
    <section id="catalogo" className="max-w-6xl mx-auto px-6 md:px-10 mt-16 mb-7">
      {/* Búsqueda: preview visual, aún no funcional a propósito. */}
      ...
      <div className="flex items-center justify-between gap-4 flex-wrap">
        ...
        {/* Filtro avanzado: al costado de las categorías, deshabilitado a propósito. */}
        <div className="flex items-center gap-4">
          <button
            disabled
            className="flex items-center gap-2 px-4 py-2 rounded-full border border-brand-borderLight bg-brand-cream text-sm text-brand-inkMuted cursor-not-allowed whitespace-nowrap"
          >
          ...
          <span className="text-sm text-brand-inkMuted whitespace-nowrap">
